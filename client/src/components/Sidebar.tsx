  ...
  return (
    <aside className="w-56 bg-white border-r border-gray-200 min-h-[calc(100vh-61px)] flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-3 rounded-lg transition-colors group">
          <img
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-900">Stebin Ben</p>
